...
const Data = [
  {
    footerHeder: "Support",
    footerTitle: [
      "Burkule Sankul,Nashik",
      "Support@Priyasales.com",
      " +91 90110 45650",
    ],
    footerLink: [],
  },
    ...
    <footer>
      <div className="container">
        <div className="row justify-content-center pt-5 pb-3">
          <div className="col-12 col-lg-4 d-flex my-0 my-lg-3 mb-3 mb-lg-0">
            <div>
              <h4>Priya Sales</h4>
              <h6 className="mb-4 mt-4">Subscribe</h6>
              <div>
          ...
          {Data.map((item, index) => (
            <div key={index} className="col-12 col-lg-2 my-">
