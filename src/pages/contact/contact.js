...
const Contact = ({ Data, SetData }) => {
  ...
  return (
    <>
      <Helmet>
        <title>Priya Sales | Contact</title>
        <meta name="description" content="Priya Sales | Contact" />
      </Helmet>
            ...
            <div className="col-12 col-lg-12 d-flex justify-content-center align-items-center">
              <div className="contactInfo px-4 py-5">
                <div>
                  ...
                  <span className="d-block pt-2">Phone: +91 90110 45650</span>
                </div>
                <hr className="my-4" />
                <div>
                  <div className="d-flex">
                  ...
                  <span className="d-block pt-2">
                    Email: customer@priyasales.com
                  </span>
                  <span className="d-block pt-1">
                    Email: support@priysales.com
                  </span>
                </div>
              </div>
            </div>
